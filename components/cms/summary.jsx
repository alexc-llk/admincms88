    ...
    return (
        <div className='flex gap-3 mt-2 flex-wrap justify-center'>
            ...
            <div className='flex flex-col justify-end py-5 px-5 rounded-md w-[100%] lg:flex-1 gap-3 text-[0.8rem]'>
                ...
                <select onChange={handleChange} name="hostname" id="hostname" className="flex border-2 self-end w-[250px] rounded-sm p-2 focus:outline-none" defaultValue="select">
